...
void PathNodesPrint()
{
    ...
    int newlines = max(0, (height - 18) / 2);
    
    // Print the newlines
    cout << string(newlines, '\n');

    int padding = max(0, (width - 81) / 2);

    cout << string(padding, ' ') << " \033[4m\033[35m\\o=o>\033[0m" << endl;
    cout << "\a";

    cout << string(padding, ' ') << "\033[34m ________   _______    _______  _______     \033[36m  _______    _______  _______   _______\033[0m" << endl;
    cout << string(padding, ' ') << "\033[34m/  ______\\  |  __  \\   |_   _|  | ____ \\ \033[36m     |  __  \\   |_   _|  | ____ \\  |  ___|\033[0m" << endl;
    cout << string(padding, ' ') << "\033[34m| |         | |__)  |    | |    | |   \\ |  \033[36m   | |__)  |    | |    | |   \\ | | |___\033[0m" << endl;
    cout << string(padding, ' ') << "\033[34m| |   ____  |  __  /     | |    | |   | |   \033[36m  |  __  /     | |    | |   | | |  ___|\033[0m" << endl;
    cout << string(padding, ' ') << "\033[34m| |  /__  | | |  \\ \\     | |    | |   | | \033[36m    | |  \\ \\     | |    | |   | | | |\033[0m" << endl;
    cout << string(padding, ' ') << "\033[34m| |_____| | | |   \\ \\   _| |_   | |___/ | \033[36m    | |   \\ \\   _| |_   | |___/ | | |___\033[0m" << endl;
    cout << string(padding, ' ') << "\033[34m\\________/  |_|    \\_\\ |_____|  |______/ \033[36m     |_|    \\_\\ |_____|  |______/  |_____|\033[0m" << endl;
